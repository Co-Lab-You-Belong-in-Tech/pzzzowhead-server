...
module.exports = class User {
  ...
  static async insert(userName, phoneNumber, wakeUpTime, weekday, sleepLength, bedTimeAlarm, windDownTime,  windDownAlarm, personality) {
    ...
    const {rows} = await pool.query(
      `INSERT INTO users (
        ...
        [userName, phoneNumber, wakeUpTime, weekday, sleepLength, bedTimeAlarm, windDownTime, windDownAlarm, personality]
    );

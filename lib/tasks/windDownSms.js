    ...
    return Promise.all(
      users.map(user => {
        ...
        return client.messages.create({
          ...
          from: twilio,
          body: `We sent you a message at this date: ${theDate}! Your name is ${user.user_name}. Your wind down alarm was set for ${convertToStandardTime(user.wind_down_alarm)}`
        });
      })
    );
  })
